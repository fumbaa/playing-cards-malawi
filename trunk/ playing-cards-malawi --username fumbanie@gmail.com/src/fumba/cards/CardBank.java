...
/**
 * The <code>CardBank</code> class represents a collection of {@link Card Cards}
 * that are used in the game application. This class extracts images from the
 * {@link R.drawable Android R.drawable} class and assigns them to appropriate
 * card.
 * <p>
 * The cards are stored in a hashmap and appropriate accessor methods are
 * provided. The {@link Controller Controller} class collects necessary buttons
 * from an instance this class in a fashion that promotes recyling of the cards.
 * 
 * <p>
...
public class CardBank {
	...
	/**
	 * Android interface that provides the global information of the
	 * application.
	 **/
	...
	private void initialise() {
		...
		this.cardMap.add(new Card(this.context, "3C", R.drawable.fgl3club,
				this.controller));
		this.cardMap.add(new Card(this.context, "3D", R.drawable.fgl3d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "4C", R.drawable.fgl4club,
				this.controller));
		this.cardMap.add(new Card(this.context, "4D", R.drawable.fgl4d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "5C", R.drawable.fgl5club,
				this.controller));
		this.cardMap.add(new Card(this.context, "5D", R.drawable.fgl5d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "6C", R.drawable.fgl6club,
				this.controller));
		this.cardMap.add(new Card(this.context, "6D", R.drawable.fgl6d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "7C", R.drawable.fgl7club,
				this.controller));
		this.cardMap.add(new Card(this.context, "7D", R.drawable.fgl7d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "8C", R.drawable.fgl8club,
				this.controller));
		this.cardMap.add(new Card(this.context, "8D", R.drawable.fgl8d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "9C", R.drawable.fgl9club,
				this.controller));
		this.cardMap.add(new Card(this.context, "9D", R.drawable.fgl9d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "XC", R.drawable.fgl10club,
				this.controller));
		this.cardMap.add(new Card(this.context, "XD", R.drawable.fgl10d,
				this.controller));
		...
		this.cardMap.add(new Card(this.context, "KC", R.drawable.kclub,
				this.controller));
		this.cardMap.add(new Card(this.context, "KD", R.drawable.kd,
				this.controller));
		this.cardMap.add(new Card(this.context, "KH", R.drawable.khearts,
				this.controller));
		this.cardMap.add(new Card(this.context, "KS", R.drawable.kspades,
				this.controller));

		// J
		this.cardMap.add(new Card(this.context, "JC", R.drawable.jclub,
				this.controller));
		this.cardMap.add(new Card(this.context, "JD", R.drawable.jd,
				this.controller));
		this.cardMap.add(new Card(this.context, "JH", R.drawable.jhearts,
				this.controller));
		this.cardMap.add(new Card(this.context, "JS", R.drawable.jspades,
				this.controller));
	 ...
	 * 
	 * @param card
	 *            Card to be put into the bank for recycling
	 */
