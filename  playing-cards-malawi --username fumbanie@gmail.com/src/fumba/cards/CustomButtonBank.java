 ...
 * {@link CustomButton Custom Buttons} that are used in the game application.
 * This class extracts images from the {@link R.drawable Android R.drawable}
 * class and assigns them to appropriate buttons.
 * <p>
 * The buttons are stored in a hashmap and appropriate accessor methods are
 * provided. The {@link Controller Controller} class collects necessary buttons
 * from an instance this class in a fashion that promotes recyling of the button
 * resources.
 * 
 * <p>
...
public class CustomButtonBank {
        ...
        /**
         * A hashmap key for the button that starts the game. This buttons shows on
         * the main welcome screen.
         **/
        public static int START_BUTTON = 1;

        /**
         * A hashmap key for the button that takes users to the previous screen when
         * they are navigating the game application.
         **/
        public static int BACK_BUTTON = 2;

        /**
         * A hashmap key for the button that shows when the current player is ready
         * to pass the android device to the next player during gameplay.
         **/
         ...
         * 
         * @param context
         *            applications global information
         * @see <a
