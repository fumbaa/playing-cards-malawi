...
public class SoundBank {
	...
	/** A collection of sounds that can be loaded into memory from resources in the APK (Application Package File) **/
	...
	/** The sample rate converter quality. Cuurrently has no effect- use 0 for default **/
	...
	private void initSounds() {
		soundPool = new SoundPool(this.maxStreams, this.streamType, this.srcQuality);
		
		int input1 = soundPool.load(this.context, R.raw.error, 1); //context, raw_source, priority
	...
	/**
	 * Plays the sound 
	 * @param sound int acting as the key of the sound
	 */
